...
export default function AboutPage() {
  ...
  return (
    // FIX: Changed to overflow-hidden globally to strip layout jank completely
    <div className="w-full flex flex-col overflow-hidden">
      ...
      <section className="relative py-20 bg-surface-container-low border-b border-outline-variant/30 flex items-center justify-center animate-[fadeIn_0.6s_ease-out]">
        ...
        <div className="relative z-10 text-center px-gutter">
          ...
          <p className="text-lg text-on-surface-variant font-medium">(మా గురించి)</p>
          <div className="h-0.5 w-24 bg-secondary mx-auto mt-6 opacity-50"></div>
        </div>
      </section>

      {/* Guruji Profile Section - Scroll Reveal */}
      <section ref={addToRefs} className="reveal-on-scroll py-20 px-gutter max-w-6xl mx-auto w-full">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          
          {/* Image Container */}
          {/* FIX: Wrapped in a relative box with right padding to cushion the absolute translated effect layout */}
          <div className="lg:col-span-5 relative pr-4 pb-4">
            {/* FIX: Kept the look but tamed the translation properties slightly to guarantee zero layout container popping */}
            <div className="absolute inset-0 bg-secondary/20 translate-x-3 translate-y-3 rounded-xl"></div>
            <div className="relative rounded-xl border border-secondary/30 p-2 bg-surface shadow-lg overflow-hidden aspect-[3/4] flex items-center justify-center">
              <span className="material-symbols-outlined text-[120px] text-surface-variant">person</span>
            </div>
          </div>

          {/* Text Content */}
          <div className="lg:col-span-7 space-y-6">
            <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-surface-container border border-outline-variant/50 text-sm font-semibold text-primary">
              <span className="material-symbols-outlined text-[18px]">verified</span>
              <span>Vedic Parampara</span>
            </div>
            ...
            <div className="flex items-center gap-8 py-4">
              ...
              <div className="flex flex-col">
                <span className="text-4xl font-serif font-bold text-primary">10k+</span>
        ...
        <div className="max-w-6xl mx-auto px-gutter">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              ...
              { name: "Lakshmi P.", location: "Vijayawada", initial: "L", review: "We consult Guruji for all major family decisions, from marriages to griha pravesham. His deep knowledge of panchangam is unmatched." },
              ...
              <div key={idx} className="bg-surface rounded-xl p-8 border border-secondary/20 shadow-sm hover:shadow-md transition-shadow flex flex-col">
